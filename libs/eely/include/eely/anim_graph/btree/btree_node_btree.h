...
namespace eely {
// Blendtree that plays another blendtree.
class btree_node_btree final : public btree_node_base {
public:
  // Construct empty node.
  explicit btree_node_btree() = default;

  // Construct node from a memory buffer.
  explicit btree_node_btree(bit_reader& reader);
